...
import { UpcomingOpenShiftsTable } from './UpcomingOpenShiftsTable';
import { Button } from '../ui/Button';

interface UpcomingOpenShiftsModalProps {
  onClose: () => void;
}

export function UpcomingOpenShiftsModal({ onClose }: UpcomingOpenShiftsModalProps) {
  return (
    <div className="bg-white rounded-lg shadow-xl w-full h-full">
      <div className="p-4 border-b border-dark/10 flex justify-between items-center print:hidden">
        <h2 className="text-xl font-semibold text-dark">Upcoming Open Shifts</h2>
